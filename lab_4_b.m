...
subplot(131), imshow(img), title('Original Image', 'FontSize', 15);
subplot(132), imshow(noisy_image), title('Gaussian Noise Image', 'FontSize', 15);
subplot(133), imshow(output_image, [ ]), title('Ideal Low Pass Image', 'FontSize', 15);
